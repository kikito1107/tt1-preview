    ...
    <div class="container">
        ...
        <form>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nombre" value="Ramírez González Enrique Saúl">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Dirección</label>
                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="calle #1 col. ejemplo" value="Jardineros #40 int. 204 col. Morelos">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Correo electrónico</label>
                <input disabled="true" type="email" class="form-control" id="exampleInputEmail1" placeholder="ejemplo@mail.com" value="enriquesaul1@hotmail.com">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Teléfono</label>
                <input type="email" class="form-control" id="exampleInputEmail1" placeholder="55555555" value="5527242816">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input disabled="true" type="file" id="exampleInputFile">
            </div>
            <div class="form-group">
